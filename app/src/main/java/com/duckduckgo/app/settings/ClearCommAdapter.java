...
public class ClearCommAdapter extends RecyclerView.Adapter<ClearCommAdapter.ClearCommHolder> {
    ...
    ArrayList<DataAccessDescriptor> dataAccessDescriptors = new ArrayList<DataAccessDescriptor>() {{
        add(new DataAccessDescriptor(
                ...
                "Internet Connection",
                "connect you to the internet and browse different website",
                false,
                true,
                "connect to our website",
                true,
                "connect to various third party websites"
        ));
        add(new DataAccessDescriptor(
                Manifest.permission.ACCESS_NETWORK_STATE,
                "Network State",
                "determine whether the device is connected to the internet and how (via wifi, mobile data, etc)",
                false,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                ...
                "Foreground Services",
                "create new services that run in the foreground",
                false,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                ...
                "Device Wake Status",
                "prevent the device from falling asleep",
                false,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                ...
                "Install Referrer Services",
                "install referrer services in order to ?",
                false,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                ...
                "Device Boot Status",
                "determine whether the device is powered on or not",
                false,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                ...
                "save information to device storage",
                false,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                ...
                "read information from the device storage",
                false,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                ...
                "Shortcut Creation",
                "create shortcuts that allow you to quickly access websites from your home screen",
                false,
                false,
                "N/A",
                false,
        ...
        add(new DataAccessDescriptor(
                ...
                "grant websites access to your device location for various features",
                false,
                false,
                "N/A",
                true,
                "share your device location with various websites that may need it"
        ));
        add(new DataAccessDescriptor(
                Manifest.permission.ACCESS_COARSE_LOCATION,
                "Device Coarse Location",
                "grant websites access to your device location for various features",
                false,
                false,
                "N/A",
